...
namespace Final_Project_Group20_1
{
    public class MajorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MajorID,StudentMajor")] Major major)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MajorID,StudentMajor")] Major major)
        {
            if (id != major.MajorID)
            {
                return NotFound();
